...
extern "C" {
    pub fn rsmi_compute_process_info_get(procs: * mut RsmiProcessInfo, num_items: *mut u32) -> RocmErr;
    pub fn 	rsmi_compute_process_info_by_pid_get(pid: u32, proc: *mut RsmiProcessInfo) -> RocmErr;
